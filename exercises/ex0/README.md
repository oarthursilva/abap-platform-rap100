...
- [Group ID](#group-id)
- [Create an  _ABAP Project_ in ADT](#create-an-abap-project-in-adt)
...
> 
> **YOUR GROUP ID IS YOUR USERNAME IN SA5**
> 
...
The group ID is your username in SA5 - e.g. `E147422`.
...
> In this step, you will create a connection to the ABAP system in your ADT installation. To do this, you need to create an _**ABAP Project**_ that poins to SA5. -->
...
> Create an _**ABAP Project**_ in your ADT installation to connect it to the SAP S/4HANA system **SA5**.
>
