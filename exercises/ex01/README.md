...
- [1.1 - Create an ABAP package](#exercise-1.1%3A-create-an-abap-package)
- [1.2 - Create a database table](#exercise-1.2%3A-create-a-database-table)
- [1.3 - Create a data generator class](#exercise-1.3%3A-create-a-data-generator-class)
- [1.4 - Generate the transactional UI services](#exercise-1.4%3A-generate-the-transactional-ui-service)
- [1.5 - Adjust metadata extension](#excercise-1.5%3A-adjust-metadata-extension)
- [1.6 - Publish and Preview the Travel App](#exercise-1.6%3A-publish-and-preview-the-travel-app)
- [Summary](#summary)
...
> This ABAP package will contain all the artefacts you will be creating in the different exercises of this hands-on session.
 ...
 <details>
  <summary>Click to expand!</summary>
   ...
   1. In ADT, go to the **Project Explorer**, right-click on the package **`ZRAP`**, and select **New** > **ABAP Package** from the context menu.

      <!-- ![package](images/p1a.png)   -->
      <!-- <img src="images/p1a.png" alt="table" width="50%"> -->

   2. Maintain the required information (`###` is your group ID, please choose a suitable combination of numbers and characters, e.g. **`E147422`**):
       - Name: **`ZRAP100_###`**
  ...
  <summary>Click to expand!</summary>
   ...
   5. Replace the default code with the code snippet provided below and replace all occurences of the placeholder **`###`** with your group ID using the **Replace All** function (**Ctrl+F**).
      ...
      define table zrap100_### {
        ...
        @Semantics.amount.currencyCode : 'zrap100_###.currency_code'
...
> Create an ABAP class![class](images/adt_class.png) to generate demo _travel_ data.
 ...
 <details>
  <summary>Click to expand!</summary>
   ...
   7. Open your database table ![table](images/adt_tabl.png)**`ZRAP100_###`** and press **F8** to start the data preview and display the filled database entries, i.e. _travel_ data.
...
> The generated business service will be transactional, draft-enabled, and enriched with UI semantics for the generation of the Fiori elements app.
  ...
  <summary>Click to expand!</summary>
   ...
   1. Right-click your database table ![table](images/adt_tabl.png)**`ZRAP100_###`**  and select **Generate ABAP Repository Objects** from the context menu.
  ...
  **Caution:**
  ...
  <summary><span style="text-decoration: line-through;">Click to expand for <b>Cloud System</b></span></summary>

   1. Select **OData UI Service** and click **Next >**.

       ![class](images/newgenerator2.png)
      <!-- <img src="images/newgenerator2.png" alt="table" width="50%"> -->

   2. Click **Next >**.  

       ![class](images/newgenerator3.png)
      <!-- <img src="images/newgenerator3.png" alt="table" width="50%"> -->

   3. Enter a description.

       ![class](images/newgenerator4.png)
  ...
  <details>
   <summary>Click to expand for <b>On Premise system release 2022 and lower</b></summary>
  ...
  --------------------------------------------------------------------------------------
   ...
   1. Maintain the required information on the **Configure Generator** dialog to provide the name of your data model and generate them.
      ...
      > - **[Naming Conventions in the Virtual Data Model](https://help.sap.com/docs/SAP_S4HANA_CLOUD/0f69f8fb28ac4bf48d2b57b9637e81fa/8a8cee943ef944fe8936f4cc60ba9bc1.html)**
      > - **[Naming Conventions for Development Objects](https://help.sap.com/docs/ABAP_PLATFORM_NEW/fc4c71aa50014fd1b43721701471913d/8b8f9d8f3cb948b2841d6045a255e503.html?locale=en-US)**
...
>> 
  ...
  <summary>Click to expand!</summary>
   ...
   4. The class checks for the existence of the package **`ZRAP100_###`** and for the existience of a table **`ZRAP100_###`**. The output in the *Console Window* shows that       the needed artifacts have been generated.
...
- ![document](images/doc.png) [Table ZRAP100_###](sources/EX1_TAB_ZRAP100_.txt)
